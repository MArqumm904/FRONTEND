...
export default function CreatePostImage({ onClose, selectedImage, profileId,userData }) {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/user/profile/imageposts`,
        formData,
        {
          headers: {
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
              <img
                ...
                className="w-full h-auto rounded-full object-cover max-h-96"
                alt="User"
              />
            </div>
